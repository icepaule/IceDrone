...
![Frame v1 render](cad/renders/frame_v1.png)
...
>
> 📖 Full documentation with step-by-step build instructions: **[icepaule.github.io/IceDrone](https://icepaule.github.io/IceDrone/)** (also readable directly in [`docs/`](docs/)).
...
Start at [`docs/README.md`](docs/README.md) for the full table of contents, or read the same content as a website at **[icepaule.github.io/IceDrone](https://icepaule.github.io/IceDrone/)**. The detailed, step-by-step assembly and test procedure lives in [`docs/05_BUILD_AND_TEST.md`](docs/05_BUILD_AND_TEST.md).
